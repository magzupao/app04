...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../conversacion.test-samples';

import { ConversacionService } from './conversacion.service';

const requireRestSample: IConversacion = {
...
describe('Conversacion Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Conversacion', () => {
      ...
      const conversacion = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(conversacion).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Conversacion', () => {
      const conversacion = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(conversacion).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addConversacionToCollectionIfMissing', () => {
      it('should add a Conversacion to an empty array', () => {
        const conversacion: IConversacion = sampleWithRequiredData;
      ...
      it("should add a Conversacion to an array that doesn't contain it", () => {
        const conversacion: IConversacion = sampleWithRequiredData;
        const conversacionCollection: IConversacion[] = [sampleWithPartialData];
        expectedResult = service.addConversacionToCollectionIfMissing(conversacionCollection, conversacion);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(conversacion);
      });
      ...
      it('should add only unique Conversacion to an array', () => {
        const conversacionArray: IConversacion[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const conversacionCollection: IConversacion[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const conversacion: IConversacion = sampleWithRequiredData;
        const conversacion2: IConversacion = sampleWithPartialData;
    ...
    describe('compareConversacion', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareConversacion(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareConversacion(entity1, entity2);
        const compareResult2 = service.compareConversacion(entity2, entity1);
